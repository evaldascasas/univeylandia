...
<body>
  <nav class="navbar navbar-expand-sm py-0">
    <div class="collapse navbar-collapse flex-row-reverse" id="collapsibleNavbar">
      ...
      <li>
        <a class="nav-link" href="cistella/index.php">Cistella</a>
      </li>
      </ul>
    </div>
  </nav>
...
<div class="container" style="margin-top:30px">
  <div class="row">
    <div class="col-sm-12">
      <h1 class="font-weight-bold text-center text-uppercase">fotos</1>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-6">
      <div class="card flex-md-row mb-4 box-shadow h-md-250">
        <div class="card-body d-flex flex-column align-items-start">
          <strong class="d-inline-block mb-2 text-success">Fotos</strong>
          <h3 class="mb-0">
            <a class="text-dark" href="#">Foto en el Dragon Khan</a>
          </h3>
            <p class="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
              <form method="post">
                <?php
                include_once("cistella/clases/producto.php");
                
              //  session_start();
                echo '<button id="foto" onClick="addProduct('.$code.')">';
                 ?>
  ...
  <div class="col-sm-6">
    <div class="card flex-md-row mb-4 box-shadow h-md-250">
      <div class="card-body d-flex flex-column align-items-start">
        <strong class="d-inline-block mb-2 text-success">Vídeos</strong>
        <h3 class="mb-0">
          <a class="text-dark" href="#">Vídeo en el Tutuki Splash</a>
        </h3>
          <p class="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>

          <button onClick="addProduct(2)">
            Afegir a la cistella
          </button>
...
<script type="text/javascript" src="cistella/js/functions.js"></script>
