        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <ul class="nav flex-column collapse show" id="submenu3" data-parent="#sidebar">
              <li class="nav-item">
                <a class="nav-link nav-interior active" href="../atraccio/registreAtraccions.php"><span data-feather="plus-square"></span>Crear Atracció</a>
              </li>
              <li class="nav-item">
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form class="needs-validation" method="post" action="registrar_atraccio.php">
          <div class="form-row">
