       ...
       <nav class="col-md-2 bg-light sidebar collapse show" id="sidebar">
           ...
           <ul class="nav flex-column">
             ...
             <ul class="nav flex-column collapse show" id="submenu4" data-parent="#sidebar">
               ...
               <ul class="nav flex-column collapse" id="sub-submenu3" data-parent="#submenu4">
                 ...
                 <li class="nav-item">
                   <a class="nav-link nav-interior2" href="../reservaHabitacio/consultarReservaHabitacio.php"><span data-feather="star"></span>Consultar Reserva Hab</a>
                 </li>
                 <li class="nav-item">
               ...
               <li class="nav-item">
                 <a class="nav-link nav-interior active" data-toggle="collapse" aria-expanded="true" href="#sub-submenu2">
               ...
               <ul class="nav flex-column collapse show" id="sub-submenu2" data-parent="#submenu4">
                 <li class="nav-item">
                   <a class="nav-link nav-interior2 active" href="../restaurant/inserirTaula.php"><span data-feather="star"></span>Inserir Taula</a>
                 </li>
                 <li class="nav-item">
               ...
               <ul class="nav flex-column collapse" id="sub-submenu4" data-parent="#submenu4">
                 ...
                 <li class="nav-item">
                   <a class="nav-link nav-interior2" href="../reservaRestaurant/consultarReservaTaula.php"><span data-feather="star"></span>Consultar Reserva Taula</a>
                 </li>
                 <li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Crear Taula</h1>
          </div>

          <form  method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
            <div class="form-row">
              <div class="col-md-3 mb-3">
                <label for="cognom">Número de taula *</label>
                <input type="text" class="form-control form-control-sm" placeholder="Nº taula" name="numTaula" required>
              </div>
              <div class="col-md-3 mb-3">
                <label for="cognom2">Número de cadires *</label>
                <input type="text" class="form-control form-control-sm" placeholder="Nº cadires" name="numCadira" required>
              </div>
            </div>
          ...
          <?php
            include_once $_SERVER['DOCUMENT_ROOT']."/php/class/classeTaula.php";
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Crear taules de forma massiva</h1>
          </div>
