       ...
       <nav class="col-md-2 bg-light sidebar collapse show" id="sidebar">
           ...
           <ul class="nav flex-column">
             ...
             <ul class="nav flex-column collapse show" id="submenu4" data-parent="#sidebar">
               ...
               <ul class="nav flex-column collapse show" id="sub-submenu2" data-parent="#submenu4">
                 ...
                 <li class="nav-item">
                   <a class="nav-link nav-interior2 active" href="../restaurant/llistarTaula.php"><span data-feather="star"></span>Llistar Taula</a>
                 </li>
               </ul>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                  <h1 class="h2">Administrar Taules</h1>
                  ...
                  <?php
                    ...
                    echo '      <input class="form-control" type="text" name="busqueda_taula" placeholder="Filtrar...">';
                    echo '    </div>';
                    echo '    <div class="form-group row">';
                    echo '      <div class="offset-sm-2 col-sm-10">';
                    echo '        <input type="submit" class="btn btn-primary" name="buscar_taula" value="Filtrar">';
                    echo '      </div>';
                    echo '    </div>';
                    echo '  </div>';
                    echo '</form>';

                    if (isset($_POST['buscar_taula'])) {
                      Taula::llistarTaulaBusqueda();
                    } else {
                      Taula::llistar();
                    }
                    if (isset($_POST['modificar'])) {
                      Taula::modificarTaula();
                    }
