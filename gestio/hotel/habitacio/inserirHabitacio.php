        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <ul class="nav flex-column collapse show" id="submenu4" data-parent="#sidebar">
              <li class="nav-item">
                <a class="nav-link nav-interior active" data-toggle="collapse" aria-expanded="true" href="#sub-submenu1">
              ...
              <ul class="nav flex-column collapse show" id="sub-submenu1" data-parent="#submenu4">
                <li class="nav-item">
                  <a class="nav-link nav-interior2 active" href="../habitacio/inserirHabitacio.php"><span data-feather="star"></span>Inserir Habitacions</a>
                </li>
                <li class="nav-item">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-3 mb-3">
                <label for="exampleFormControlFile1">Pujar arxiu .CSV amb dades d'habitacions</label>
