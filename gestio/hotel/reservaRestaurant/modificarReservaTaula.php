      ...
      <div class="row">
            ...
            <ul class="nav flex-column">
              ...
              <ul class="nav flex-column collapse show" id="submenu4" data-parent="#sidebar">
                ...
                <ul class="nav flex-column collapse show" id="sub-submenu4" data-parent="#submenu4">
                    ...
                    <li class="nav-item">
                      <a class="nav-link nav-interior2 active" href="../reservaRestaurant/modificarReservaTaula.php"><span data-feather="star"></span>Modificar Reserva Taula</a>
                    </li>
                    <li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Modificar Reserva Restaurant</h1>
          </div>
