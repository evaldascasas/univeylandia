  ...
  <div class="container">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>
                  <a href="cartAction.php?action=removeCartItem&id=<?php echo $item["rowid"]; ?>" class="btn btn-danger" onclick="return confirm('Segur?')"><i class="glyphicon glyphicon-trash"></i></a>
              </td>
          </tr>
          <?php } }else{ ?>
          <tr><td colspan="5"><p>La teva cistella està buida</p></td>
          <?php } ?>
      </tbody>
      <tfoot>
          <tr>
              <td><a href="carritooo.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i>Segueix comprant</a></td>
              <td colspan="2"></td>
              <?php if($cart->total_items() > 0){ ?>
              <td class="text-center"><strong>Total <?php echo $cart->total().' €'; ?></strong></td>
              <td><a href="checkout.php" class="btn btn-success btn-block">Pagar<i class="glyphicon glyphicon-menu-right"></i></a></td>
              <?php } ?>
          </tr>
      </tfoot>
      </table>
