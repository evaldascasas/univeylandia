...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark py-4">
  ...
  <div class="container">
      ...
      <div id="products" class="row list-group">
          ...
          //get rows query
          $query = $connection->query("SELECT * FROM products ORDER BY id DESC LIMIT 10");
          if($query->num_rows > 0){
              ...
              <div class="thumbnail">
                  <div class="caption">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <a class="btn btn-success" href="cartAction.php?action=addToCart&id=<?php echo $row["id"]; ?>">Afegir a la cistella</a>
                          </div>
                      </div>
                  </div>
              </div>
