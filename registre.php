...
<div class="container jumbotron" style="margin-top:30px">
  <div class="row">
      ...
      <form action="php/registrar_client.php" method="post" class="align-items-center justify-content-center d-flex">
        <div class="col-sm-12">
          ...
          <div class="row">
            <div class="col-3">
              <div class="form-group">
                <button type="button" class="btn btn-primary" onclick="display_hidden_fields()">Captcha</button>
                <div id="hidden" style="display:none">
                  <br>
                  <div>
                    <img src="" id="imagenCaptchaNumeric" width="200px" height="100 px">
                  </div>
                  <br>
                  <form action="">
                  ...
                  <br>
                  <button type="button" class="btn btn-primary" id="mostrarOperacioCaptcha" onclick="GenerarCaptchaImatge()">Canvi</button>
                  <button type="submit" onclick="ComprovarCaptchaImatge()" name="registrar" class="btn btn-primary">Envia</button>
