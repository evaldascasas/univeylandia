...
<body>
  <nav class="navbar navbar-expand-sm py-0">
    <div class="collapse navbar-collapse flex-row-reverse" id="collapsibleNavbar">
      ...
      <li>
        <a class="nav-link" href="index.php">Cistella</a>
      </li>
      </ul>
    </div>
  </nav>
...
?>
	...
	<div class="col-8 mx-auto" style="text-align:center;">
		<table class="table table-dark table-striped" border="1px" cellpadding="5px" width="100%">
			<thead display="off">
				<tr>
					<th colspan="6">Cistella</th>
				</tr>
				<tr>
		...
		<table border="1px" cellpadding="5px" width="100%">
			<tr>
				<th colspan="6">Productes relacionats</th>
			</tr>
			<tr>
				<th>Codi</th>
				<th>Producte</th>
