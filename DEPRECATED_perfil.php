...
<div class="container" style="margin-top:30px">
  <div class="row">
    <div class="col-sm-8">
      <h5> Benvingut a Univeylandia-Parc.cat </h5>
      Lorem ipsum dolor sit amet, consectetur adipisicing elit, occaecat cupidatat non proident,
  ...
  <div class="row py-4">
    <div class="col-sm-8">
      ...
      <button type="button" class="btn btn-primary">Baixa</button>

    </div>
    <div class="col-sm-4">
      <button type="button" class="btn btn-primary">Pujar una foto</button>
    </div>
  </div>
</div>
